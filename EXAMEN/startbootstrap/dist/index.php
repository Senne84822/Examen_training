...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Ga Lekker Reizen" />
    ...
    <body id="page-top" class="bg-primary">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        {  ?>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="../read_reis.php">Reizen</a></li>
                        <?php }
                        else {}
                        ?>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead logo plaatje-->
                <img class="masthead-avatar mb-5" src="../src/assets/img/glr_logo.png" alt="..." />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Ga Lekker Reizen</h1>
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Reisbureau GLR</p>
            </div>
        </header>
        <section class="page-section bg-primary text-white mb-4" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">Wij zijn Reisbureau Ga Lekker Reizen. Via ons reisbureau kunnen studenten met korting een leuke reis boeken. De reisjes worden door het GLR georgaiseerd. </p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">Log snel in en miss de kans op een boeking niet! Als het vol zit zit het vol!</p></div>
                </div>
            </div>
        </section>
        <!-- Footer-->
        <footer class="footer text-center text-white bg-secondary">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Footer Over tekst-->
                    <div class="col-lg-4">
                        <h4 class="text-uppercase mb-4">Over Ga Lekker Reizen</h4>
                        <p class="lead mb-0">
                            Reisbureau van
        ...
        <div class="copyright py-4 text-center bg-secondary text-white">
            <div class="container"><small>Copyright &copy; Senne de Crom 2022</small></div>
        </div>
